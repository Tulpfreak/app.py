...
def index():
    ...
    afbeelding_url = url_for('static', filename='background_image.png')  # Vervang 'jouw_afbeelding.png' door de naam van je afbeelding
    ...
    <body>
        <div class="container">
            <div class="afbeelding-container">
                <img src="{{ afbeelding_url }}" alt="Economische Begrippen" style="max-width: 100%; height: auto;">
            </div>
            {% if antwoord %}
    ...
    '''
    return render_template_string(html, antwoord=antwoord, afbeelding_url=afbeelding_url)
